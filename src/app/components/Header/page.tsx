      ...
      <div className="grid grid-cols-2">
        <div>
          ...
          <p className="p-2 text-zinc-300 text-xl font-serif">
            Sou formado em Análise e Desenvolvimento de Sistemas e estou no
            oitavo semestre de Ciência da Computação. Busco minha primeira
            oportunidade como desenvolvedor fullstack júnior ou estagiário.
            Tenho conhecimentos em tecnologias como JavaScript, TypeScript,
            React, Next.js, Node.js, NestJS, HTML, CSS, Tailwind, PostgreSQL e
